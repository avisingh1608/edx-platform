...
from .helpers import (
    FormDescription, set_course_id_from_analytics, shim_student_view, require_post_params
)
...
class RegistrationView(APIView):
    ...
    def post(self, request):
        ...
        This can also be provided as a JSON-encoded "analytics" parameter with
        an "enroll_course_id" field, but that approach is deprecated.
        ...
        set_course_id_from_analytics(data)
